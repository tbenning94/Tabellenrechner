	...
	public void setLiga(String sportart, int saison,int bisSpieltag) throws IOException {
		switch (sportart) {
			case "1. Fußballbundesliga":
				this.liga = new Liga("Fußball", saison, new Fußball(1), new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
			case "2. Fußballbundesliga":
				this.liga = new Liga("Fußball", saison, new Fußball(2), new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
		}
