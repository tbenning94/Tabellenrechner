...
public class Koordinator {
	...
	public void setLiga(String sportart, int saison,int bisSpieltag) throws IOException {
		switch (sportart) {
			case Liga.ersteFußballBundesliga:
				this.liga = new Liga(sportart, saison, new Fußball("bl1"), new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
			case Liga.zweiteFußballBundesliga:
				this.liga = new Liga(sportart, saison, new Fußball("bl2"), new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
		}
	...
	public void setLiga(String sportart, int saison,int bisSpieltag,String url) throws IOException {
		ISportart sport;
		switch (sportart) {
			case "1. Fußballbundesliga":
				if(url==null){
					sport= new Fußball("bl1");
				}else{
					sport= new Fußball(url,"bl1");
				}
				this.liga = new Liga("Fußball", saison, sport, new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
			case "2. Fußballbundesliga":
				if(url==null){
					sport= new Fußball("bl2");
				}else{
					sport= new Fußball(url,"bl2");
				}
				this.liga = new Liga("Fußball", saison, sport, new Meisterschaft(bisSpieltag,ComparatorChain.CC_FUßBALL_MEISTERSCHAFT));
				this.aktiveGruppenLiga=liga;
				break;
